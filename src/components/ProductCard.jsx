...
const ProductCard = ({ product, setHoveredId, hoveredId }) => {
    return (
        <>
            <motion.div
                className={`shadow-lg w-full relative bg-white mb-2 rounded-2xl overflow-hidden   group
            ${hoveredId === product.id ? "h-[400px]" : "h-[380px]"}`}
            ...
            >
                    ...
                    <div className="grid grid-cols-2 gap-2 text-sm mt-1">
                        ...
                        {product.weight_unit && (
                            <div className="flex flex-col">
                                ...
                                <span className="font-medium text-gray-700 uppercase">{product.weight_unit}</span>
                            </div>
                        )}
                    </div>
                ...
                {/* Add to Cart Button */}
                <motion.button
                    className="absolute bottom-0 left-0 right-0 bg-green-500 text-white py-3
